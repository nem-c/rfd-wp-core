...
const MicroModal = (() => {
    ...
    class Modal {
        ...
        setFocusToFirstNode() {
            ...
            const focusableNodes = this.getFocusableNodes(); // no focusable nodes
        ...
        retainFocus(event) {
            let focusableNodes = this.getFocusableNodes(); // no focusable nodes
...
if (typeof micromodal_on_show !== 'function') {
    window.micromodal_on_show = function (modal, event) {
        return true;
    };
}

if (typeof micromodal_on_close !== 'function') {
    window.micromodal_on_close = function (modal, event) {
        return true;
    };
}
...
jQuery(function ($) {
    MicroModal.init(
        {
            onShow: modal => micromodal_on_show(modal, event),
            onClose: modal => micromodal_on_close(modal, event),
