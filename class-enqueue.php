...
class Enqueue {
	...
	protected function load_frontend_configuration() {
		$config_array = $this->load_config_file( $config_file_path = RFD_CORE_CONFIG_PATH . 'enqueue.php' );
		$this->store_configuration( $config_array );
	}

	protected function load_admin_configuration() {
		$config_array = $this->load_config_file( $config_file_path = RFD_CORE_CONFIG_PATH . 'admin/enqueue.php' );
	...
	protected function store_configuration( array $config_array, string $type = 'frontend' ) {
		...
		$js_config  = $config_array['js'] ?? [];
		$css_config = $config_array['css'] ?? [];
